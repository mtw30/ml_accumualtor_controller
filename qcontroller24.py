class qcontroller24:
    'Has the intergral and double the cell count multiplier'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_24/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_24/qrienforcmentmodel.h5")
