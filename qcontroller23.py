class qcontroller23:
    'Literally the same as 22, but even less punishement for consuming the battery'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_23/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_23/qrienforcmentmodel.h5")
