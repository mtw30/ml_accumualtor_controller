class qcontroller13:
    'Found out that the previous controllers are just the same value every time. This one is 500 epochs, mse'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_13/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_13/qrienforcmentmodel.h5")
