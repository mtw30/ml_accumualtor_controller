class qcontroller11:
    'ALl the previous controllers just seem to be the same value every time. Gone for binary_crossentropy instead'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_11/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_11/qrienforcmentmodel.h5")
