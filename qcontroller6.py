class qcontroller6:
    'Iteration 9 of the qlearning controller.\nBound non-terminal rewards between 1,-1'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_6/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_6/qrienforcmentmodel.h5")
