class qcontroller21:
    'Worked from the basis of 19, but ran for 5000 epochs'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_21/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_21/qrienforcmentmodel.h5")
