class qcontroller19:
    'Input derivatives as an extra three slots on the end of the data row, data row counts now reduced to two. This contoller has to be changed slightly now to track the derivitives'
