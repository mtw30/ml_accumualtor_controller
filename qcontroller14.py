class qcontroller14:
    'Started using a different loss catagorical_crossentropy'
    ...
    def __init__(self):
        ...
        jsonFile = open('ml_attempt_14/qrienforcmentmodel.json', 'r')
        loadedModelJSON = jsonFile.read()
        jsonFile.close()
        self.model = model_from_json(loadedModelJSON)
        # Load the weights into thr new model
        self.model.load_weights("ml_attempt_14/qrienforcmentmodel.h5")
